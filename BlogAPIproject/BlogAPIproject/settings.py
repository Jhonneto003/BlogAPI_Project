...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'BlogService.apps.BlogserviceConfig',
...
DJOSER = {
    ...
    'SERIALIZERS': {
        'user_create': 'UserService.serializers.CustomUserCreateSerializer',
        'user': 'UserService.serializers.CustomUserSerializer',
    },
